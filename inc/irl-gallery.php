...
add_action( 'wp_head', function () {
	...
	<style>
		...
		.fyfaen-irl__item{margin:0;overflow:hidden;background:var(--fy-soft);min-width:0;aspect-ratio:4/5;display:flex;align-items:center;justify-content:center;line-height:0}
