<?php
/**
 * FYFAEN theme bootstrap.
 *
 * The theme owns presentation. WooCommerce and payment plugins remain responsible
 * for commerce, checkout, orders and payment processing.
 */
